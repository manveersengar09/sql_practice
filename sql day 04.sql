...
select * from employees ORDER BY employee_id ASC;
-----------------------------------------------------------------------------------
-- day 5 { no codes only theory}+{create handwritten notes}
-----------------------------------------------------------------------------------


-----------------------------------------------------------------------------------
-- day 6 { no codes only theory}+{create handwritten notes}
-----------------------------------------------------------------------------------

-----------------------------------------------------------------------------------
-- day 7 { no codes only theory}+{create handwritten notes}
-----------------------------------------------------------------------------------

-----------------------------------------------------------------------------------
-- day 8 {import CSV file in sql}+{also create file in excel}
-----------------------------------------------------------------------------------
...
FROM 'C:/Users/HP/Downloads/employee_datasql.csv'
DELIMITER ','
CSV HEADER;

select * from employee2;
-----------------------------------------------------------------------------------
-- day 9 { import CSV File Directly into SQL}+{also create handwritten notes}
-----------------------------------------------------------------------------------
...
--click on table then right click on employee3 and then import file
--also on header and add file from folder and choose csv

select * from employee3;
-----------------------------------------------------------------------------------
-- day 10 { type of operators}+{also create handwritten notes}
-----------------------------------------------------------------------------------
-- TYPE OF OPERATORS
...
select * from employee3;
select first_name ,salary,(salary*0.10)
as bonus from employee3;

--2} calculate the annual salary and salary increament by 50%- show the mounthly new salary as well.......
